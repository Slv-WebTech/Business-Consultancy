...
function Number() {
  ...
  useEffect(() => {
    ...
    // Start the countdown when the user hovers
    if (hovered) {
      ...
      return () => {
        ...
        // Reset the countdown when not hovering
      };
    }
  }, [countdown1, countdown2, countdown3, countdown4, hovered, maxValue1, maxValue2, maxValue3, maxValue4]);
